...
public class TranslatableTest {
    ...
    public void testExecutable() {
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get2", type(Circle.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get3", type(Circle.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get4", type(Circle.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get5", type(Circle.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get6", type(Circle.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get2", type(Cylinder.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get3", type(Cylinder.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get4", type(Cylinder.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get5", type(Cylinder.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get6", type(Cylinder.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get2", type(Sphere.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get3", type(Sphere.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get4", type(Sphere.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get5", type(Sphere.class))));
        ...
        assertEquals("", translate(TYPE_ARGUMENT_IMPORT, member("get6", type(Sphere.class))));
    }

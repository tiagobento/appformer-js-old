  ...
  describe("get", () => {
    ...
    describe("with FULL profile", () => {
      ...
      test("should return a correct design card", () => {
        ...
        expect((designDescription[1] as CardDescriptionLinkElement).text).toEqual("pages");
        expect((designDescription[1] as CardDescriptionLinkElement).targetId).toEqual("ContentManagerPerspective");

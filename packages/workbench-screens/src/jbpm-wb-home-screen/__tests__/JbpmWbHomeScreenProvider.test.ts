  ...
  describe("get", () => {
    ...
    test("with FULL and PLANNER_AND_RULES profile", () => {
      [Profile.FULL, Profile.PLANNER_AND_RULES].forEach(profile => {
        ...
        expect((manageCard.description.elements[0] as CardDescriptionTextElement).text).toEqual(
        ...
        expect((trackCard.description.elements[0] as CardDescriptionTextElement).text).toEqual(

...
export default class ConsoleDock extends React.Component<Props, {}> {
    ...
    render() {
        return <div style={{
            ...
            <span onClick={() => this.props.showRPC()} style={{
                opacity: this.props.status.rpcConsole
                    ? 0.4
                    : 1,
            }}>
            ...
            <span onClick={() => this.props.showEvents()} style={{
                opacity: this.props.status.eventsConsole
                    ? 0.4
                    : 1,
            }}>
...
export class DockButton extends React.Component<{ title: string }, {}> {
    ...
    render() {
        return <div ref={e => this.cont = e!}>
            <button ref={e => this.rot = e!} style={{
                top: "-26px",
                position: "relative",

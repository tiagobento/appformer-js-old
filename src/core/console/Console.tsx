...
const actions = {
    ...
    "toggleEventsConsole": (state: State) => ({eventsConsole: !state.eventsConsole}),
};
    ...
    render() {
        return <div className={"wrapper"}>
            ...
            <span style={{gridColumn: "span 6"}} hidden={!this.state.eventsConsole}>
                <EventsSimulationConsole screens={this.props.screens} onClose={() => this.setState(actions.toggleEventsConsole)}/>
            </span>
